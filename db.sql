...
CREATE TABLE `blog_members` (
  ...
  `userDob` varchar(30) DEFAULT NULL,
...
INSERT INTO `blog_members` (`memberID`, `username`, `password`, `email`, `userDob`)
VALUES
  (1,'Demo','$2y$10$wJxa1Wm0rtS2BzqKnoCPd.7QQzgu7D/aLlMR5Aw3O.m9jx3oRJ5R2','demo@demo.com', '10/10/2010');
...
CREATE TABLE `blog_posts` (
  ...
  `postOwner` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`postID`)
);
...
CREATE TABLE `blog_comments` (
  ...
  `commentOwner` varchar(50) DEFAULT NULL,
